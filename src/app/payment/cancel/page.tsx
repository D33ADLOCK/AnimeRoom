    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--color-nb-bg)] px-4">
      <div className="flex w-full max-w-md flex-col items-center gap-6 rounded-none border-[4px] border-black bg-white p-8 shadow-[8px_8px_0px_rgba(0,0,0,1)]">
        ...
        <div className="flex w-full flex-col gap-3">
          <Link
            href="/billing"
            className="flex w-full items-center justify-center gap-2 rounded-none border-[3px] border-black bg-[var(--color-nb-yellow)] py-3.5 text-sm font-black uppercase tracking-widest shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_rgba(0,0,0,1)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none"
          >
